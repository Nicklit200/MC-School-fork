...
public class LessonPreparationService {
    ...
    public LessonPreparationResponse uploadWorkbook(AuthenticatedUser teacher, String eventId, String filename, byte[] pdf) {
        ...
        // Backward compatibility for ChatGPT connections that still expose the
        // older prepare_lesson schema with only driveWorkbookFileId/workbookFilename.
        // When the supplied filename clearly represents an answer key, store the
        // PDF in the dedicated teacher-answers slot instead of overwriting the workbook.
    ...
    private boolean isAnswersCompatibilityFilename(String filename) {
        ...
        // Accept natural filenames generated by ChatGPT as well, so a cached
        // connector schema can still attach answers without knowing the magic prefix.
